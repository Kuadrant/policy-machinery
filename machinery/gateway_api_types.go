...
func (g *GatewayClass) GetIdentity() string {
	return IdentityFromObject(g)
}
...
func (g *Gateway) GetIdentity() string {
	return IdentityFromObject(g)
}
...
func (l *Listener) GetIdentity() string {
	return namespacedSectionName(IdentityFromObject(l.Gateway), l.Name)
}
...
func (r *HTTPRoute) GetIdentity() string {
	return IdentityFromObject(r)
}
...
func (r *HTTPRouteRule) GetIdentity() string {
	return namespacedSectionName(IdentityFromObject(r.HTTPRoute), r.Name)
}
...
func (r *GRPCRoute) GetIdentity() string {
	return IdentityFromObject(r)
}
...
func (r *GRPCRouteRule) GetIdentity() string {
	return namespacedSectionName(IdentityFromObject(r.GRPCRoute), r.Name)
}
...
func (r *TCPRoute) GetIdentity() string {
	return IdentityFromObject(r)
}
...
func (r *TCPRouteRule) GetIdentity() string {
	return namespacedSectionName(IdentityFromObject(r.TCPRoute), r.Name)
}
...
func (r *TLSRoute) GetIdentity() string {
	return IdentityFromObject(r)
}
...
func (r *TLSRouteRule) GetIdentity() string {
	return namespacedSectionName(IdentityFromObject(r.TLSRoute), r.Name)
}
...
func (r *UDPRoute) GetIdentity() string {
	return IdentityFromObject(r)
}
...
func (r *UDPRouteRule) GetIdentity() string {
	return namespacedSectionName(IdentityFromObject(r.UDPRoute), r.Name)
}
...
// targetRef instances can be treated as Objects whose GetIdentity() functions return the unique identifier of the
// corresponding targetable the reference points to.
// This is the reason why GetIdentity() was adopted to get the unique identifiers of topology objects instead of more
...
func (t NamespacedPolicyTargetReference) GetIdentity() string {
...
func (t LocalPolicyTargetReference) GetIdentity() string {
	return IdentityFromObject(t)
}
...
func (t LocalPolicyTargetReferenceWithSectionName) GetIdentity() string {
	return IdentityFromObject(t)
}
...
func (o *ReferenceGrant) GetIdentity() string {
...
func (p *BackendTLSPolicy) GetIdentity() string {
...
func (p *BackendLBPolicy) GetIdentity() string {
	return IdentityFromObject(p)
}
