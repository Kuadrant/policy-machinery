...
func (g *GatewayClass) GetLocator() string {
	return LocatorFromObject(g)
}
...
func (g *Gateway) GetLocator() string {
	return LocatorFromObject(g)
}
...
func (l *Listener) GetLocator() string {
	return namespacedSectionName(LocatorFromObject(l.Gateway), l.Name)
}
...
func (r *HTTPRoute) GetLocator() string {
	return LocatorFromObject(r)
}
...
func (r *HTTPRouteRule) GetLocator() string {
	return namespacedSectionName(LocatorFromObject(r.HTTPRoute), r.Name)
}
...
func (r *GRPCRoute) GetLocator() string {
	return LocatorFromObject(r)
}
...
func (r *GRPCRouteRule) GetLocator() string {
	return namespacedSectionName(LocatorFromObject(r.GRPCRoute), r.Name)
}
...
func (r *TCPRoute) GetLocator() string {
	return LocatorFromObject(r)
}
...
func (r *TCPRouteRule) GetLocator() string {
	return namespacedSectionName(LocatorFromObject(r.TCPRoute), r.Name)
}
...
func (r *TLSRoute) GetLocator() string {
	return LocatorFromObject(r)
}
...
func (r *TLSRouteRule) GetLocator() string {
	return namespacedSectionName(LocatorFromObject(r.TLSRoute), r.Name)
}
...
func (r *UDPRoute) GetLocator() string {
	return LocatorFromObject(r)
}
...
func (r *UDPRouteRule) GetLocator() string {
	return namespacedSectionName(LocatorFromObject(r.UDPRoute), r.Name)
}
...
// targetRef instances can be treated as Objects whose GetLocator() functions return the unique identifier of the
// corresponding targetable the reference points to.
// This is the reason why GetLocator() was adopted to get the unique identifiers of topology objects instead of more
...
func (o *ReferenceGrant) GetLocator() string {
...
func (p *BackendTLSPolicy) GetLocator() string {
