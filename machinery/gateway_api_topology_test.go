	...
	testCases := []struct {
		...
		},
		{
			...
			expectedLinks: map[string][]string{
				...
				"my-gateway":       {"my-http-route", "my-grpc-route", "my-tcp-route"},
		...
		},
		{
			...
			expectedLinks: map[string][]string{
				...
				"gateway-3":      {"http-route-4", "http-route-5"},
				"gateway-4":      {"http-route-5", "tcp-route-1"},
	...
	testCases := []struct {
	...
	}{
		{
			...
			expectedLinks: map[string][]string{
				...
				"my-gateway#my-listener": {"my-http-route", "my-grpc-route", "my-tcp-route"},
		...
		},
		{
			...
			expectedLinks: map[string][]string{
				...
				"gateway-3#listener-1": {"http-route-4", "http-route-5"},
				"gateway-3#listener-2": {"http-route-4", "http-route-5"},
				"gateway-4#listener-1": {"http-route-5", "tcp-route-1"},
				"gateway-4#listener-2": {"http-route-5", "tcp-route-1"},
				...
				"http-route-5":         {"http-route-5#rule-1", "http-route-5#rule-2"},
				...
				"http-route-5#rule-1":  {"service-5"},
				"http-route-5#rule-2":  {"service-5"},
