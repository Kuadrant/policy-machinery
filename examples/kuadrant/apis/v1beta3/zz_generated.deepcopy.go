...
func (in *AuthPolicySpecProper) DeepCopyInto(out *AuthPolicySpecProper) {
	*out = *in
	if in.NamedPatterns != nil {
		...
		*out = make(map[string]v1beta2.PatternExpressions, len(*in))
		for key, val := range *in {
			var outVal []v1beta2.PatternExpression
			if val == nil {
				(*out)[key] = nil
			} else {
				inVal := (*in)[key]
	...
	if in.Conditions != nil {
		...
		*out = make([]v1beta2.PatternExpressionOrRef, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
func (in *AuthSchemeSpec) DeepCopyInto(out *AuthSchemeSpec) {
	*out = *in
	if in.Authentication != nil {
		...
		*out = make(map[string]v1beta2.AuthenticationSpec, len(*in))
		for key, val := range *in {
	...
	if in.Metadata != nil {
		...
		*out = make(map[string]v1beta2.MetadataSpec, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
	if in.Authorization != nil {
		...
		*out = make(map[string]v1beta2.AuthorizationSpec, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
	if in.Response != nil {
		...
		*out = new(v1beta2.ResponseSpec)
		(*in).DeepCopyInto(*out)
	}
	if in.Callbacks != nil {
		in, out := &in.Callbacks, &out.Callbacks
		*out = make(map[string]v1beta2.CallbackSpec, len(*in))
		for key, val := range *in {
			(*out)[key] = *val.DeepCopy()
		}
	}
